<template>
  <input type="text" v-bind:class='className' :placeholder='placeholde' :name ='name' :required='required' v-model='model' 
    @focus='foucus'
    @blur='blur'
    @keyup='keyup'
  >
...
export default {
  ...
  methods: {
    foucus (e) {
      this.$parent.focused(e, this)
      this.focused = true
    },
    blur (e) {
      this.$parent.blurred(e, this)
      this.focused = false
    },
    keyup (e) {
